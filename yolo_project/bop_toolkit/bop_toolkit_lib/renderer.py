...
"""
import sys
# sys.path.append("../bop_toolkit/bop_toolkit_lib")
...
def create_renderer(width, height, renderer_type='cpp', mode='rgb+depth',
  ...
  elif renderer_type == "vispy_v2":
    from bop_toolkit_lib import renderer_vispy_v2
    return renderer_vispy_v2.RendererVispy(width, height, mode, shading, bg_color)
