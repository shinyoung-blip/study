...
import subprocess
import numpy as np
sys.path.append("/home/jxl522/6D_Pose_All_In_One/RDD_v2/ZebraPose")
from bop_toolkit.bop_toolkit_lib import config
from bop_toolkit_lib import inout
from bop_toolkit.bop_toolkit_lib import misc

def cal_select_obj_error_3(result_filename_ = 'ape_lmo-test.csv', select_obj = '1', ):
    ...
    for error in p['errors']:
      ...
      for error_sign, error_dir_path in error_dir_paths.items():
        for correct_th in error['correct_th']:
          ...
          recalls.append(scores['obj_recalls'][p['select_obj']])
  ...
  misc.log('Done.')
  return final_scores['bop19_average_recall'], 
if __name__ == '__main__':
  error_ = cal_select_obj_error_3(result_filename_ = 'ape_lmo-test.csv', select_obj = '1', )
  pass